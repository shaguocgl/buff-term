...
- [ ] 输出脱敏：命令输出进入模型前过滤敏感信息
- [ ] MCP 协议支持：Agent 可消费 / 暴露 MCP 工具生态
- [ ] 监控面板：服务器资源与状态可视化（CPU / 内存 / 磁盘 / 网络 / 进程）
- [ ] 告警通知：阈值告警，支持桌面通知、邮件、Webhook 等渠道
- [ ] AI 定时巡检：按计划自动巡检服务器，发现风险或攻击迹象及时通知，并支持一键响应处置
