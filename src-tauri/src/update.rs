...
const RELEASES_LATEST_URL: &str =
    "https://api.github.com/repos/shaguocgl/keywisp-agent/releases/latest";
...
pub async fn check_for_update() -> Result<UpdateInfo, String> {
    ...
    let client = reqwest::Client::builder()
        .user_agent(concat!("KeyWisp-Agent/", env!("CARGO_PKG_VERSION")))
        .build()
    ...
    if response.status() == reqwest::StatusCode::NOT_FOUND {
        return Ok(UpdateInfo {
            ...
            release_url: "https://github.com/shaguocgl/keywisp-agent/releases".to_string(),
            release_found: false,
        });
    }
